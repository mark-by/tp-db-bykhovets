...
type Thread interface {
	Create(forumSlug string, thread *entity.Thread) (*entity.Thread, error)
	...
	Update(thread *entity.Thread) (*entity.Thread, error)
	Voice(thread *entity.Thread) (*entity.Thread, error)
}
